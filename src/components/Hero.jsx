    ...
    <section className="pt-24 lg:pt-32">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold leading-tight">I am {data.name}
            <span className="block text-2xl sm:text-3xl font-bold text-primary mt-2">Mahasiswa Statistika + AI Enthusiast / Web Developer</span>
          </h1>
          <p className="mt-4 text-subText max-w-xl">{data.about}</p>

          <div className="mt-6 flex gap-3">
            <a href="#" className="px-4 py-2 rounded-md border border-primary text-primary">Download CV</a>
            <a href="#contact" className="px-4 py-2 rounded-md bg-primary text-black">Contact Me</a>
          </div>
